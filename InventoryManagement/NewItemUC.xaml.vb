...
Public Class NewItemUC
    ...
    Private Sub ADDNEWBUTTON_click(sender As Object, e As RoutedEventArgs) Handles Addnewbutton.Click
...
(@NameItem, @Description, @IDTag, @Loc, @Stock, @Purchase, @Retail, @Barc)", con)
   ...
   Not item.TagID.ToString().Contains(TAGCOMBO.SelectedValue.ToString()) Then
        ...
        If Not String.IsNullOrWhiteSpace(ItemID.Text) AndAlso Not newid = 1 AndAlso
    ...
    Private Sub Edititemwindow_loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        SearchResult.Columns(5).Visibility = Visibility.Hidden
        SearchResult.Columns(6).Visibility = Visibility.Hidden
        SearchResult.Columns(7).Visibility = Visibility.Hidden
        SearchResult.Columns(8).Visibility = Visibility.Hidden
        SearchResult.Columns(9).Visibility = Visibility.Hidden
        SearchResult.Columns(10).Visibility = Visibility.Hidden
        SearchResult.Columns(11).Visibility = Visibility.Hidden
        SearchResult.Columns(12).Visibility = Visibility.Hidden
        SearchResult.Columns(13).Visibility = Visibility.Hidden
        SearchResult.Columns(14).Visibility = Visibility.Hidden


        For Each column As DataGridColumn In SearchResult.Columns
    ...
    Private Sub Button3_click(sender As Object, e As RoutedEventArgs)
        Dim mainGrid As Grid = TryCast(Me.Parent, Grid)
 ...
 Barcode =  @Barc WHERE SerielNumber = @ID", con)
    ...
    Private Sub textchanged_changed(sender As Object, e As RoutedEventArgs) Handles ItemID.TextChanged
